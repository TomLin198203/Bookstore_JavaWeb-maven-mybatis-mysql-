	...
	*/
    ...
    <c:forEach items="${parents}" var="parent">
      <c:forEach items="${parent.children}" var="child">
        ...
        --%>
	bar.add("圖書管理", "查看全部圖書", "<c:url value='/admin/AdminBookServlet?method=findAll'/>", "body");
	<c:forEach items="${requestScope.categoryList}" var="category">
		bar.add("圖書管理", "${category.cname}", "/bookstore/admin/AdminBookServlet?method=findByCategory&cid=${category.cid}", "body");
	</c:forEach>
